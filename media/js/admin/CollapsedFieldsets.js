...
var CollapsedFieldsets = {
    ...
    init: function() {
        ...
        if (collapsed_seen) {
            // Expand all collapsed fieldsets when form is submitted - why?
    ...
    show: function(fieldset_index) {
        ...
        fs.className = fs.className.replace(CollapsedFieldsets.collapsed_re, '').replace('expanded', '');
    ...
    hide: function(fieldset_index) {
        ...
        fs.className += ' expanded ' + CollapsedFieldsets.collapsed_class;
